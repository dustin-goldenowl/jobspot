...
class BottomSheetLevel extends StatelessWidget {
  const BottomSheetLevel({
    super.key,
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            AppLocal.text.add_job_page_choose_employee_level,
            style: AppStyles.boldTextHaiti.copyWith(fontSize: 18),
          ),
          const SizedBox(height: 10),
          Text(
            AppLocal.text.add_job_page_choose_employee_level_content,
          ...
          ListView.separated(
            ...
            itemCount: AppLists.listLevel.length,
          )
        ],
      ),
    );
