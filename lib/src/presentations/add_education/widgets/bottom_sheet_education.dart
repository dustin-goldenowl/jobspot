...
class BottomSheetEducation extends StatelessWidget {
  const BottomSheetEducation({
    super.key,
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            isRemove
                ? AppLocal.text.add_education_page_delete_title
                : AppLocal.text.add_education_page_save_title,
            style: TextStyle(
          ...
          Text(
            isRemove
                ? AppLocal.text.add_education_page_delete_content
                : AppLocal.text.add_education_page_save_content,
