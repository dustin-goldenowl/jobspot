...
@lazySingleton
class FavouriteCommentUseCase
    extends UseCase<DataState<bool>, FavouriteEntity> {
  final ViewPostRepository _repository;

  FavouriteCommentUseCase(this._repository);

  @override
  Future<DataState<bool>> call({required FavouriteEntity params}) {
    return _repository.favouriteComment(params);
  }
}
