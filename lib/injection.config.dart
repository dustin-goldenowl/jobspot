...
import 'package:jobspot/injection.dart' as _i56;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i39.FetchJobUseCase>(
        () => _i39.FetchJobUseCase(gh<_i28.ViewJobRepository>()));
    ...
    gh.factory<_i42.HomeCubit>(
        () => _i42.HomeCubit(gh<_i40.FetchJobUseCase>()));
    ...
    gh.factory<_i53.ViewJobCubit>(
        () => _i53.ViewJobCubit(gh<_i39.FetchJobUseCase>()));
    ...
    gh.factory<_i55.SignInCubit>(() => _i55.SignInCubit(
