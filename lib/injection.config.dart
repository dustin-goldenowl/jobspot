...
import 'package:jobspot/injection.dart' as _i154;
...
import 'package:jobspot/src/presentations/edit_applicant_profile/domain/use_cases/update_user_info_use_case.dart'
    as _i72;
import 'package:jobspot/src/presentations/home/cubit/home_cubit.dart' as _i114;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i102.FetchJobUseCase>(
        () => _i102.FetchJobUseCase(gh<_i78.ViewJobRepository>()));
    gh.lazySingleton<_i103.FetchJobUseCase>(
        () => _i103.FetchJobUseCase(gh<_i26.HomeRepository>()));
    gh.lazySingleton<_i104.FollowUserUseCase>(
        () => _i104.FollowUserUseCase(gh<_i76.ViewCompanyProfileRepository>()));
    ...
    gh.lazySingleton<_i106.GetCountriesUseCase>(
        () => _i106.GetCountriesUseCase(gh<_i42.SearchLanguageRepository>()));
    gh.factory<_i107.GetEducationUseCase>(() =>
        _i107.GetEducationUseCase(gh<_i74.ViewApplicantProfileRepository>()));
    gh.lazySingleton<_i108.GetLanguageUseCase>(() =>
        _i108.GetLanguageUseCase(gh<_i74.ViewApplicantProfileRepository>()));
    gh.lazySingleton<_i109.GetListJobUseCase>(
        () => _i109.GetListJobUseCase(gh<_i76.ViewCompanyProfileRepository>()));
    gh.lazySingleton<_i110.GetListSkillUseCase>(
        () => _i110.GetListSkillUseCase(gh<_i52.SkillRepository>()));
    gh.lazySingleton<_i111.GetResumeUseCase>(() =>
        _i111.GetResumeUseCase(gh<_i74.ViewApplicantProfileRepository>()));
    gh.lazySingleton<_i112.GetUserInfoUseCase>(() =>
        _i112.GetUserInfoUseCase(gh<_i74.ViewApplicantProfileRepository>()));
    gh.lazySingleton<_i113.GetWorkExperienceUseCase>(() =>
        _i113.GetWorkExperienceUseCase(
            gh<_i74.ViewApplicantProfileRepository>()));
    gh.factory<_i114.HomeCubit>(() => _i114.HomeCubit(
          gh<_i103.FetchJobUseCase>(),
          gh<_i40.SaveJobUseCase>(),
        ));
    gh.factory<_i115.JobPositionCubit>(
        () => _i115.JobPositionCubit(gh<_i41.SearchJobPositionUseCase>()));
    gh.lazySingleton<_i116.ListenSaveJobUseCase>(
        () => _i116.ListenSaveJobUseCase(gh<_i38.SaveJobRepository>()));
    gh.factory<_i117.NotificationCubit>(() => _i117.NotificationCubit(
    ...
    gh.lazySingleton<_i118.RegisterApplicantUseCase>(
        () => _i118.RegisterApplicantUseCase(gh<_i50.SignUpRepository>()));
    gh.lazySingleton<_i119.RegisterBusinessUseCase>(
        () => _i119.RegisterBusinessUseCase(gh<_i50.SignUpRepository>()));
    gh.lazySingleton<_i120.RegisterGoogleUseCase>(
        () => _i120.RegisterGoogleUseCase(gh<_i50.SignUpRepository>()));
    gh.factory<_i121.SaveJobCubit>(() => _i121.SaveJobCubit(
          gh<_i116.ListenSaveJobUseCase>(),
    ...
    gh.lazySingleton<_i124.SignInEmailPasswordUseCase>(
        () => _i124.SignInEmailPasswordUseCase(gh<_i48.SignInRepository>()));
    gh.lazySingleton<_i125.SignInGoogleUseCase>(
        () => _i125.SignInGoogleUseCase(gh<_i48.SignInRepository>()));
    gh.factory<_i126.SignUpCubit>(() => _i126.SignUpCubit(
          gh<_i118.RegisterApplicantUseCase>(),
          gh<_i119.RegisterBusinessUseCase>(),
          gh<_i120.RegisterGoogleUseCase>(),
        ));
    gh.lazySingleton<_i127.StreamLanguagesUseCase>(
        () => _i127.StreamLanguagesUseCase(gh<_i80.ViewLanguageRepository>()));
    ...
    gh.factory<_i129.ViewJobCubit>(
        () => _i129.ViewJobCubit(gh<_i102.FetchJobUseCase>()));
    ...
    gh.factory<_i149.ViewApplicantProfileCubit>(
        () => _i149.ViewApplicantProfileCubit(
              ...
              gh<_i111.GetResumeUseCase>(),
              gh<_i25.GetSkillUseCase>(),
              gh<_i112.GetUserInfoUseCase>(),
              gh<_i113.GetWorkExperienceUseCase>(),
              gh<_i56.StreamListPostUseCase>(),
              gh<_i142.FavouritePostUseCase>(),
            ));
    gh.factory<_i150.ViewCompanyProfileCubit>(
        () => _i150.ViewCompanyProfileCubit(
              gh<_i109.GetListJobUseCase>(),
              gh<_i56.StreamListPostUseCase>(),
              gh<_i112.GetUserInfoUseCase>(),
              gh<_i142.FavouritePostUseCase>(),
              gh<_i104.FollowUserUseCase>(),
            ));
    gh.factory<_i151.ViewPostBloc>(() => _i151.ViewPostBloc(
    ...
    gh.factory<_i152.ApplicantProfileCubit>(() => _i152.ApplicantProfileCubit(
    ...
    gh.factory<_i153.ConnectionCubit>(() => _i153.ConnectionCubit(
...
class _$InjectionModule extends _i154.InjectionModule {}
