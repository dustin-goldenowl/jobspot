...
import 'package:jobspot/src/presentations/connection/domain/use_cases/fetch_post_use_case.dart'
    as _i15;
import 'package:jobspot/src/presentations/home/cubit/home_cubit.dart' as _i43;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i36.DeleteCommentUseCase>(
        () => _i36.DeleteCommentUseCase(gh<_i30.ViewPostRepository>()));
    gh.lazySingleton<_i37.FavouriteCommentUseCase>(
        () => _i37.FavouriteCommentUseCase(gh<_i30.ViewPostRepository>()));
    gh.lazySingleton<_i38.FavouritePostUseCase>(
        () => _i38.FavouritePostUseCase(gh<_i30.ViewPostRepository>()));
    ...
    gh.lazySingleton<_i45.RegisterApplicantUseCase>(
        () => _i45.RegisterApplicantUseCase(gh<_i24.SignUpRepository>()));
    gh.lazySingleton<_i46.RegisterBusinessUseCase>(
        () => _i46.RegisterBusinessUseCase(gh<_i24.SignUpRepository>()));
    gh.lazySingleton<_i47.RegisterGoogleUseCase>(
        () => _i47.RegisterGoogleUseCase(gh<_i24.SignUpRepository>()));
    gh.lazySingleton<_i48.ReplyCommentUseCase>(
        () => _i48.ReplyCommentUseCase(gh<_i30.ViewPostRepository>()));
    gh.lazySingleton<_i49.SendCommentUseCase>(
        () => _i49.SendCommentUseCase(gh<_i30.ViewPostRepository>()));
    gh.lazySingleton<_i50.SignInEmailPasswordUseCase>(
        () => _i50.SignInEmailPasswordUseCase(gh<_i22.SignInRepository>()));
    gh.lazySingleton<_i51.SignInGoogleUseCase>(
        () => _i51.SignInGoogleUseCase(gh<_i22.SignInRepository>()));
    gh.factory<_i52.SignUpCubit>(() => _i52.SignUpCubit(
          gh<_i45.RegisterApplicantUseCase>(),
          gh<_i46.RegisterBusinessUseCase>(),
          gh<_i47.RegisterGoogleUseCase>(),
        ));
    ...
    gh.factory<_i55.ViewPostBloc>(() => _i55.ViewPostBloc(
          ...
          gh<_i38.FavouritePostUseCase>(),
          gh<_i49.SendCommentUseCase>(),
          gh<_i53.SyncPostDataUseCase>(),
          gh<_i48.ReplyCommentUseCase>(),
          gh<_i42.GetReplyCommentUseCase>(),
          gh<_i36.DeleteCommentUseCase>(),
        ));
    gh.factory<_i56.SignInCubit>(() => _i56.SignInCubit(
          gh<_i50.SignInEmailPasswordUseCase>(),
          gh<_i51.SignInGoogleUseCase>(),
        ));
    return this;
  }
}
