...
import 'package:jobspot/injection.dart' as _i172;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i81.ViewApplicantProfileRepository>(
        () => _i82.ViewApplicantProfileRepositoryImpl());
    gh.lazySingleton<_i83.ViewJobApplicantRepository>(() =>
        _i84.ViewJobApplicantRepositoryImpl(
            gh<_i51.SendNotificationUseCase>()));
    gh.lazySingleton<_i85.ViewJobRepository>(
        () => _i86.ViewJobRepositoryImpl());
    gh.lazySingleton<_i87.ViewLanguageRepository>(
        () => _i88.ViewLanguageRepositoryImpl());
    gh.lazySingleton<_i89.AddAppreciationUseCase>(
        () => _i89.AddAppreciationUseCase(gh<_i12.AppreciationRepository>()));
    gh.lazySingleton<_i90.AddEducationUseCase>(
        () => _i90.AddEducationUseCase(gh<_i20.EducationRepository>()));
    gh.lazySingleton<_i91.AddExperienceUseCase>(
        () => _i91.AddExperienceUseCase(gh<_i22.ExperienceRepository>()));
    gh.factory<_i92.AddJobCubit>(() => _i92.AddJobCubit(
          gh<_i5.AddJobUseCase>(),
          gh<_i72.UpdateJobUseCase>(),
        ));
    gh.lazySingleton<_i93.AddLanguageUseCase>(
        () => _i93.AddLanguageUseCase(gh<_i34.LanguageRepository>()));
    gh.factory<_i94.AddPostCubit>(() => _i94.AddPostCubit(
          gh<_i8.AddPostUseCase>(),
          gh<_i76.UpdatePostUseCase>(),
        ));
    gh.lazySingleton<_i95.AddResumeUseCase>(
        () => _i95.AddResumeUseCase(gh<_i40.ResumeRepository>()));
    gh.lazySingleton<_i96.ApplyJobRepository>(() => _i97.ApplyJobRepositoryImpl(
          gh<_i51.SendNotificationUseCase>(),
          gh<_i95.AddResumeUseCase>(),
        ));
    gh.lazySingleton<_i98.ApplyJobUseCase>(
        () => _i98.ApplyJobUseCase(gh<_i96.ApplyJobRepository>()));
    gh.lazySingleton<_i99.ChangePasswordUseCase>(
        () => _i99.ChangePasswordUseCase(gh<_i74.UpdatePasswordRepository>()));
    gh.lazySingleton<_i100.ConsiderCompanyUseCase>(
        () => _i100.ConsiderCompanyUseCase(gh<_i26.HomeAdminRepository>()));
    gh.lazySingleton<_i101.ConsiderResumeUseCase>(() =>
        _i101.ConsiderResumeUseCase(gh<_i83.ViewJobApplicantRepository>()));
    gh.lazySingleton<_i102.DeleteAccountUseCase>(
        () => _i102.DeleteAccountUseCase(gh<_i52.SettingRepository>()));
    gh.lazySingleton<_i103.DeleteAllSaveJobUseCase>(
        () => _i103.DeleteAllSaveJobUseCase(gh<_i42.SaveJobRepository>()));
    gh.lazySingleton<_i104.DeleteEducationUseCase>(
        () => _i104.DeleteEducationUseCase(gh<_i20.EducationRepository>()));
    gh.lazySingleton<_i105.DeleteExperienceUseCase>(
        () => _i105.DeleteExperienceUseCase(gh<_i22.ExperienceRepository>()));
    gh.lazySingleton<_i106.DeleteLanguageUseCase>(
        () => _i106.DeleteLanguageUseCase(gh<_i34.LanguageRepository>()));
    gh.lazySingleton<_i107.DeleteNotificationFromIDUseCase>(() =>
        _i107.DeleteNotificationFromIDUseCase(
            gh<_i36.NotificationRepository>()));
    gh.lazySingleton<_i108.DeleteNotificationUseCase>(() =>
        _i108.DeleteNotificationUseCase(gh<_i36.NotificationRepository>()));
    gh.lazySingleton<_i109.DeleteResumeUseCase>(
        () => _i109.DeleteResumeUseCase(gh<_i40.ResumeRepository>()));
    gh.factory<_i110.EditApplicantProfileCubit>(() =>
        _i110.EditApplicantProfileCubit(gh<_i79.UpdateUserInfoUseCase>()));
    gh.lazySingleton<_i111.FetchJobUseCase>(
        () => _i111.FetchJobUseCase(gh<_i85.ViewJobRepository>()));
    gh.lazySingleton<_i112.FetchJobUseCase>(
        () => _i112.FetchJobUseCase(gh<_i28.HomeApplicantRepository>()));
    gh.lazySingleton<_i113.GetAppreciationUseCase>(() =>
        _i113.GetAppreciationUseCase(
            gh<_i81.ViewApplicantProfileRepository>()));
    gh.lazySingleton<_i114.GetCountriesUseCase>(
        () => _i114.GetCountriesUseCase(gh<_i49.SearchLanguageRepository>()));
    gh.factory<_i115.GetEducationUseCase>(() =>
        _i115.GetEducationUseCase(gh<_i81.ViewApplicantProfileRepository>()));
    gh.lazySingleton<_i116.GetLanguageUseCase>(() =>
        _i116.GetLanguageUseCase(gh<_i81.ViewApplicantProfileRepository>()));
    gh.lazySingleton<_i117.GetListApplicantUseCase>(() =>
        _i117.GetListApplicantUseCase(gh<_i83.ViewJobApplicantRepository>()));
    gh.lazySingleton<_i118.GetListCompanyPendingUseCase>(() =>
        _i118.GetListCompanyPendingUseCase(gh<_i26.HomeAdminRepository>()));
    gh.lazySingleton<_i119.GetListMyJobUseCase>(
        () => _i119.GetListMyJobUseCase(gh<_i30.HomeCompanyRepository>()));
    gh.lazySingleton<_i120.GetListSkillUseCase>(
        () => _i120.GetListSkillUseCase(gh<_i59.SkillRepository>()));
    gh.lazySingleton<_i121.GetResumeUseCase>(() =>
        _i121.GetResumeUseCase(gh<_i81.ViewApplicantProfileRepository>()));
    gh.lazySingleton<_i122.GetUserInfoUseCase>(() =>
        _i122.GetUserInfoUseCase(gh<_i81.ViewApplicantProfileRepository>()));
    gh.lazySingleton<_i123.GetWorkExperienceUseCase>(() =>
        _i123.GetWorkExperienceUseCase(
            gh<_i81.ViewApplicantProfileRepository>()));
    gh.factory<_i124.HomeAdminCubit>(() => _i124.HomeAdminCubit(
          gh<_i118.GetListCompanyPendingUseCase>(),
          gh<_i100.ConsiderCompanyUseCase>(),
        ));
    gh.factory<_i125.HomeApplicantCubit>(() => _i125.HomeApplicantCubit(
          gh<_i112.FetchJobUseCase>(),
          gh<_i44.SaveJobUseCase>(),
        ));
    gh.factory<_i126.HomeCompanyCubit>(
        () => _i126.HomeCompanyCubit(gh<_i119.GetListMyJobUseCase>()));
    gh.factory<_i127.JobPositionCubit>(
        () => _i127.JobPositionCubit(gh<_i45.SearchJobPositionUseCase>()));
    gh.lazySingleton<_i128.ListenSaveJobUseCase>(
        () => _i128.ListenSaveJobUseCase(gh<_i42.SaveJobRepository>()));
    gh.factory<_i129.NotificationCubit>(() => _i129.NotificationCubit(
          gh<_i64.StreamNotificationUseCase>(),
          gh<_i39.ReadNotificationUseCase>(),
          gh<_i38.ReadAllNotificationUseCase>(),
          gh<_i107.DeleteNotificationFromIDUseCase>(),
        ));
    gh.lazySingleton<_i130.RegisterApplicantUseCase>(
        () => _i130.RegisterApplicantUseCase(gh<_i57.SignUpRepository>()));
    gh.lazySingleton<_i131.RegisterBusinessUseCase>(
        () => _i131.RegisterBusinessUseCase(gh<_i57.SignUpRepository>()));
    gh.lazySingleton<_i132.RegisterGoogleUseCase>(
        () => _i132.RegisterGoogleUseCase(gh<_i57.SignUpRepository>()));
    gh.factory<_i133.SaveJobCubit>(() => _i133.SaveJobCubit(
          gh<_i128.ListenSaveJobUseCase>(),
          gh<_i103.DeleteAllSaveJobUseCase>(),
          gh<_i44.SaveJobUseCase>(),
        ));
    gh.factory<_i134.SearchJobCubit>(
        () => _i134.SearchJobCubit(gh<_i48.SearchJobUseCase>()));
    gh.factory<_i135.SearchLanguageCubit>(
        () => _i135.SearchLanguageCubit(gh<_i114.GetCountriesUseCase>()));
    gh.factory<_i136.SettingCubit>(() => _i136.SettingCubit(
          gh<_i102.DeleteAccountUseCase>(),
          gh<_i78.UpdateTokenUseCase>(),
        ));
    gh.lazySingleton<_i137.SignInEmailPasswordUseCase>(
        () => _i137.SignInEmailPasswordUseCase(gh<_i55.SignInRepository>()));
    gh.lazySingleton<_i138.SignInGoogleUseCase>(
        () => _i138.SignInGoogleUseCase(gh<_i55.SignInRepository>()));
    gh.factory<_i139.SignUpCubit>(() => _i139.SignUpCubit(
          gh<_i130.RegisterApplicantUseCase>(),
          gh<_i131.RegisterBusinessUseCase>(),
          gh<_i132.RegisterGoogleUseCase>(),
        ));
    gh.lazySingleton<_i140.StreamLanguagesUseCase>(
        () => _i140.StreamLanguagesUseCase(gh<_i87.ViewLanguageRepository>()));
    gh.factory<_i141.UpdatePasswordCubit>(() => _i141.UpdatePasswordCubit(
          gh<_i99.ChangePasswordUseCase>(),
          gh<_i80.ValidatePassworkUseCase>(),
        ));
    gh.lazySingleton<_i142.ViewCompanyProfileRepository>(
        () => _i143.ViewCompanyProfileRepositoryImpl(
              gh<_i108.DeleteNotificationUseCase>(),
              gh<_i51.SendNotificationUseCase>(),
            ));
    gh.factory<_i144.ViewJobApplicantCubit>(() => _i144.ViewJobApplicantCubit(
          gh<_i117.GetListApplicantUseCase>(),
          gh<_i101.ConsiderResumeUseCase>(),
        ));
    gh.factory<_i145.ViewJobCubit>(
        () => _i145.ViewJobCubit(gh<_i111.FetchJobUseCase>()));
    gh.factory<_i146.ViewLanguageCubit>(() => _i146.ViewLanguageCubit(
          gh<_i140.StreamLanguagesUseCase>(),
          gh<_i106.DeleteLanguageUseCase>(),
        ));
    gh.lazySingleton<_i147.ViewPostRepository>(
        () => _i148.ViewPostRepositoryImpl(
              gh<_i51.SendNotificationUseCase>(),
              gh<_i108.DeleteNotificationUseCase>(),
            ));
    gh.factory<_i149.AddAppreciationCubit>(() => _i149.AddAppreciationCubit(
          gh<_i89.AddAppreciationUseCase>(),
          gh<_i69.UpdateAppreciationUseCase>(),
          gh<_i16.DeleteAppreciationUseCase>(),
        ));
    gh.factory<_i150.AddEducationCubit>(() => _i150.AddEducationCubit(
          gh<_i90.AddEducationUseCase>(),
          gh<_i104.DeleteEducationUseCase>(),
          gh<_i70.UpdateEducationUseCase>(),
        ));
    gh.factory<_i151.AddLanguageCubit>(() => _i151.AddLanguageCubit(
          gh<_i93.AddLanguageUseCase>(),
          gh<_i73.UpdateLanguageUseCase>(),
        ));
    gh.factory<_i152.AddResumeCubit>(
        () => _i152.AddResumeCubit(gh<_i95.AddResumeUseCase>()));
    gh.factory<_i153.AddSkillCubit>(() => _i153.AddSkillCubit(
          gh<_i120.GetListSkillUseCase>(),
          gh<_i77.UpdateSkillUseCase>(),
        ));
    gh.factory<_i154.AddWorkExperienceCubit>(() => _i154.AddWorkExperienceCubit(
          gh<_i91.AddExperienceUseCase>(),
          gh<_i71.UpdateExperienceUseCase>(),
          gh<_i105.DeleteExperienceUseCase>(),
        ));
    gh.factory<_i155.ApplyJobCubit>(
        () => _i155.ApplyJobCubit(gh<_i98.ApplyJobUseCase>()));
    gh.lazySingleton<_i156.DeleteCommentUseCase>(
        () => _i156.DeleteCommentUseCase(gh<_i147.ViewPostRepository>()));
    gh.lazySingleton<_i157.FavouriteCommentUseCase>(
        () => _i157.FavouriteCommentUseCase(gh<_i147.ViewPostRepository>()));
    gh.lazySingleton<_i158.FavouritePostUseCase>(
        () => _i158.FavouritePostUseCase(gh<_i147.ViewPostRepository>()));
    gh.lazySingleton<_i159.FetchDataCommentFirstLevelUseCase>(() =>
        _i159.FetchDataCommentFirstLevelUseCase(
            gh<_i147.ViewPostRepository>()));
    gh.lazySingleton<_i160.FollowUserUseCase>(() =>
        _i160.FollowUserUseCase(gh<_i142.ViewCompanyProfileRepository>()));
    gh.lazySingleton<_i161.GetListJobUseCase>(() =>
        _i161.GetListJobUseCase(gh<_i142.ViewCompanyProfileRepository>()));
    gh.lazySingleton<_i162.GetReplyCommentUseCase>(
        () => _i162.GetReplyCommentUseCase(gh<_i147.ViewPostRepository>()));
    gh.lazySingleton<_i163.ReplyCommentUseCase>(
        () => _i163.ReplyCommentUseCase(gh<_i147.ViewPostRepository>()));
    gh.lazySingleton<_i164.SendCommentUseCase>(
        () => _i164.SendCommentUseCase(gh<_i147.ViewPostRepository>()));
    gh.factory<_i165.SignInCubit>(() => _i165.SignInCubit(
          gh<_i137.SignInEmailPasswordUseCase>(),
          gh<_i138.SignInGoogleUseCase>(),
          gh<_i78.UpdateTokenUseCase>(),
        ));
    gh.lazySingleton<_i166.SyncPostDataUseCase>(
        () => _i166.SyncPostDataUseCase(gh<_i147.ViewPostRepository>()));
    gh.factory<_i167.ViewApplicantProfileCubit>(
        () => _i167.ViewApplicantProfileCubit(
              gh<_i113.GetAppreciationUseCase>(),
              gh<_i115.GetEducationUseCase>(),
              gh<_i116.GetLanguageUseCase>(),
              gh<_i121.GetResumeUseCase>(),
              gh<_i25.GetSkillUseCase>(),
              gh<_i122.GetUserInfoUseCase>(),
              gh<_i123.GetWorkExperienceUseCase>(),
              gh<_i63.StreamListPostUseCase>(),
              gh<_i158.FavouritePostUseCase>(),
            ));
    gh.factory<_i168.ViewCompanyProfileCubit>(
        () => _i168.ViewCompanyProfileCubit(
              gh<_i161.GetListJobUseCase>(),
              gh<_i63.StreamListPostUseCase>(),
              gh<_i122.GetUserInfoUseCase>(),
              gh<_i158.FavouritePostUseCase>(),
              gh<_i160.FollowUserUseCase>(),
            ));
    gh.factory<_i169.ViewPostBloc>(() => _i169.ViewPostBloc(
          gh<_i159.FetchDataCommentFirstLevelUseCase>(),
          gh<_i157.FavouriteCommentUseCase>(),
          gh<_i158.FavouritePostUseCase>(),
          gh<_i164.SendCommentUseCase>(),
          gh<_i166.SyncPostDataUseCase>(),
          gh<_i163.ReplyCommentUseCase>(),
          gh<_i162.GetReplyCommentUseCase>(),
          gh<_i156.DeleteCommentUseCase>(),
        ));
    gh.factory<_i170.ApplicantProfileCubit>(() => _i170.ApplicantProfileCubit(
          gh<_i17.DeletePostUseCase>(),
          gh<_i109.DeleteResumeUseCase>(),
          gh<_i63.StreamListPostUseCase>(),
    ...
    gh.factory<_i171.ConnectionCubit>(() => _i171.ConnectionCubit(
...
class _$InjectionModule extends _i172.InjectionModule {}
