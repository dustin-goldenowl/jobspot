...
import 'package:jobspot/injection.dart' as _i57;
...
import 'package:jobspot/src/presentations/connection/domain/use_cases/fetch_post_use_case.dart'
    as _i15;
import 'package:jobspot/src/presentations/home/cubit/home_cubit.dart' as _i42;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i35.DeleteCommentUseCase>(
        () => _i35.DeleteCommentUseCase(gh<_i30.ViewPostRepository>()));
    ...
    gh.lazySingleton<_i41.GetReplyCommentUseCase>(
        () => _i41.GetReplyCommentUseCase(gh<_i30.ViewPostRepository>()));
    gh.factory<_i42.HomeCubit>(
        () => _i42.HomeCubit(gh<_i39.FetchJobUseCase>()));
    gh.factory<_i43.JobPositionCubit>(
        () => _i43.JobPositionCubit(gh<_i20.SearchJobPositionUseCase>()));
    gh.lazySingleton<_i44.RegisterApplicantUseCase>(
        () => _i44.RegisterApplicantUseCase(gh<_i24.SignUpRepository>()));
    gh.lazySingleton<_i45.RegisterBusinessUseCase>(
        () => _i45.RegisterBusinessUseCase(gh<_i24.SignUpRepository>()));
    gh.lazySingleton<_i46.RegisterGoogleUseCase>(
        () => _i46.RegisterGoogleUseCase(gh<_i24.SignUpRepository>()));
    gh.lazySingleton<_i47.ReplyCommentUseCase>(
        () => _i47.ReplyCommentUseCase(gh<_i30.ViewPostRepository>()));
    gh.lazySingleton<_i48.SendCommentUseCase>(
        () => _i48.SendCommentUseCase(gh<_i30.ViewPostRepository>()));
    gh.lazySingleton<_i49.SignInEmailPasswordUseCase>(
        () => _i49.SignInEmailPasswordUseCase(gh<_i22.SignInRepository>()));
    gh.lazySingleton<_i50.SignInGoogleUseCase>(
        () => _i50.SignInGoogleUseCase(gh<_i22.SignInRepository>()));
    gh.factory<_i51.SignUpCubit>(() => _i51.SignUpCubit(
          gh<_i44.RegisterApplicantUseCase>(),
          gh<_i45.RegisterBusinessUseCase>(),
          gh<_i46.RegisterGoogleUseCase>(),
        ));
    gh.lazySingleton<_i52.SyncPostDataUseCase>(
        () => _i52.SyncPostDataUseCase(gh<_i30.ViewPostRepository>()));
    gh.factory<_i53.ViewJobCubit>(
        () => _i53.ViewJobCubit(gh<_i40.FetchJobUseCase>()));
    gh.factory<_i54.ViewPostBloc>(() => _i54.ViewPostBloc(
          gh<_i38.FetchDataCommentFirstLevelUseCase>(),
          gh<_i36.FavouriteCommentUseCase>(),
          gh<_i37.FavouritePostUseCase>(),
          gh<_i48.SendCommentUseCase>(),
          gh<_i52.SyncPostDataUseCase>(),
          gh<_i47.ReplyCommentUseCase>(),
          gh<_i41.GetReplyCommentUseCase>(),
          gh<_i35.DeleteCommentUseCase>(),
        ));
    gh.factory<_i55.ConnectionCubit>(() => _i55.ConnectionCubit(
          gh<_i15.FetchPostUseCase>(),
          gh<_i37.FavouritePostUseCase>(),
        ));
    gh.factory<_i56.SignInCubit>(() => _i56.SignInCubit(
          gh<_i49.SignInEmailPasswordUseCase>(),
          gh<_i50.SignInGoogleUseCase>(),
        ));
    return this;
  }
}
