...
import 'package:jobspot/injection.dart' as _i94;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i38.SaveJobUseCase>(
        () => _i38.SaveJobUseCase(gh<_i30.HomeRepository>()));
    gh.factory<_i39.SearchJobPositionUseCase>(
        () => _i39.SearchJobPositionUseCase(gh<_i32.JobPositionRepository>()));
    await gh.lazySingletonAsync<_i40.SharedPreferences>(
      () => injectionModule.prefs,
      preResolve: true,
    );
    gh.lazySingleton<_i41.SignInRepository>(() => _i42.LoginRepositoryImpl());
    gh.lazySingleton<_i43.SignUpRepository>(() => _i44.SignUpRepositoryImpl());
    gh.lazySingleton<_i45.UpdateAppreciationUseCase>(() =>
        _i45.UpdateAppreciationUseCase(gh<_i15.AppreciationRepository>()));
    gh.lazySingleton<_i46.UpdateEducationUseCase>(
        () => _i46.UpdateEducationUseCase(gh<_i21.EducationRepository>()));
    gh.lazySingleton<_i47.UpdateExperienceUseCase>(
        () => _i47.UpdateExperienceUseCase(gh<_i23.ExperienceRepository>()));
    gh.factory<_i48.UpdateJobUseCase>(
        () => _i48.UpdateJobUseCase(gh<_i3.AddJobRepository>()));
    gh.lazySingleton<_i49.UpdatePostUseCase>(
        () => _i49.UpdatePostUseCase(gh<_i6.AddPostRepository>()));
    gh.lazySingleton<_i50.ViewJobRepository>(
        () => _i51.ViewJobRepositoryImpl());
    gh.lazySingleton<_i52.ViewPostRepository>(
        () => _i53.ViewPostRepositoryImpl());
    gh.lazySingleton<_i54.AddAppreciationUseCase>(
        () => _i54.AddAppreciationUseCase(gh<_i15.AppreciationRepository>()));
    gh.lazySingleton<_i55.AddEducationUseCase>(
        () => _i55.AddEducationUseCase(gh<_i21.EducationRepository>()));
    gh.lazySingleton<_i56.AddExperienceUseCase>(
        () => _i56.AddExperienceUseCase(gh<_i23.ExperienceRepository>()));
    gh.factory<_i57.AddJobCubit>(() => _i57.AddJobCubit(
          gh<_i5.AddJobUseCase>(),
          gh<_i48.UpdateJobUseCase>(),
        ));
    gh.factory<_i58.AddPostCubit>(() => _i58.AddPostCubit(
          gh<_i8.AddPostUseCase>(),
          gh<_i49.UpdatePostUseCase>(),
        ));
    gh.lazySingleton<_i59.AddResumeUseCase>(
        () => _i59.AddResumeUseCase(gh<_i34.ResumeRepository>()));
    gh.factory<_i60.ApplicantProfileCubit>(() => _i60.ApplicantProfileCubit(
    ...
    gh.lazySingleton<_i62.DeleteAllSaveJobUseCase>(
        () => _i62.DeleteAllSaveJobUseCase(gh<_i36.SaveJobRepository>()));
    gh.lazySingleton<_i63.DeleteCommentUseCase>(
        () => _i63.DeleteCommentUseCase(gh<_i52.ViewPostRepository>()));
    ...
    gh.lazySingleton<_i66.DeleteResumeUseCase>(
        () => _i66.DeleteResumeUseCase(gh<_i34.ResumeRepository>()));
    gh.lazySingleton<_i67.FavouriteCommentUseCase>(
        () => _i67.FavouriteCommentUseCase(gh<_i52.ViewPostRepository>()));
    gh.lazySingleton<_i68.FavouritePostUseCase>(
        () => _i68.FavouritePostUseCase(gh<_i52.ViewPostRepository>()));
    gh.lazySingleton<_i69.FetchDataCommentFirstLevelUseCase>(() =>
        _i69.FetchDataCommentFirstLevelUseCase(gh<_i52.ViewPostRepository>()));
    gh.lazySingleton<_i70.FetchJobUseCase>(
        () => _i70.FetchJobUseCase(gh<_i50.ViewJobRepository>()));
    gh.lazySingleton<_i71.FetchJobUseCase>(
        () => _i71.FetchJobUseCase(gh<_i30.HomeRepository>()));
    gh.lazySingleton<_i72.GetReplyCommentUseCase>(
        () => _i72.GetReplyCommentUseCase(gh<_i52.ViewPostRepository>()));
    gh.factory<_i73.HomeCubit>(() => _i73.HomeCubit(
          gh<_i71.FetchJobUseCase>(),
          gh<_i38.SaveJobUseCase>(),
        ));
    gh.factory<_i74.JobPositionCubit>(
        () => _i74.JobPositionCubit(gh<_i39.SearchJobPositionUseCase>()));
    gh.lazySingleton<_i75.ListenSaveJobUseCase>(
        () => _i75.ListenSaveJobUseCase(gh<_i36.SaveJobRepository>()));
    gh.lazySingleton<_i76.RegisterApplicantUseCase>(
        () => _i76.RegisterApplicantUseCase(gh<_i43.SignUpRepository>()));
    gh.lazySingleton<_i77.RegisterBusinessUseCase>(
        () => _i77.RegisterBusinessUseCase(gh<_i43.SignUpRepository>()));
    gh.lazySingleton<_i78.RegisterGoogleUseCase>(
        () => _i78.RegisterGoogleUseCase(gh<_i43.SignUpRepository>()));
    gh.lazySingleton<_i79.ReplyCommentUseCase>(
        () => _i79.ReplyCommentUseCase(gh<_i52.ViewPostRepository>()));
    ...
    gh.lazySingleton<_i81.SendCommentUseCase>(
        () => _i81.SendCommentUseCase(gh<_i52.ViewPostRepository>()));
    gh.lazySingleton<_i82.SignInEmailPasswordUseCase>(
        () => _i82.SignInEmailPasswordUseCase(gh<_i41.SignInRepository>()));
    gh.lazySingleton<_i83.SignInGoogleUseCase>(
        () => _i83.SignInGoogleUseCase(gh<_i41.SignInRepository>()));
    ...
    gh.lazySingleton<_i85.SyncPostDataUseCase>(
        () => _i85.SyncPostDataUseCase(gh<_i52.ViewPostRepository>()));
    ...
    gh.factory<_i88.AddAppreciationCubit>(() => _i88.AddAppreciationCubit(
          gh<_i54.AddAppreciationUseCase>(),
          gh<_i45.UpdateAppreciationUseCase>(),
          gh<_i19.DeleteAppreciationUseCase>(),
        ));
    gh.factory<_i89.AddEducationCubit>(() => _i89.AddEducationCubit(
          gh<_i55.AddEducationUseCase>(),
          gh<_i64.DeleteEducationUseCase>(),
          gh<_i46.UpdateEducationUseCase>(),
        ));
    gh.factory<_i90.AddResumeCubit>(
        () => _i90.AddResumeCubit(gh<_i59.AddResumeUseCase>()));
    gh.factory<_i91.AddWorkExperienceCubit>(() => _i91.AddWorkExperienceCubit(
          gh<_i56.AddExperienceUseCase>(),
          gh<_i47.UpdateExperienceUseCase>(),
          gh<_i65.DeleteExperienceUseCase>(),
        ));
    gh.factory<_i92.ConnectionCubit>(() => _i92.ConnectionCubit(
          gh<_i25.FetchPostUseCase>(),
          gh<_i68.FavouritePostUseCase>(),
        ));
    gh.factory<_i93.SignInCubit>(() => _i93.SignInCubit(
