...
import 'package:jobspot/injection.dart' as _i144;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i69.ValidatePassworkUseCase>(() =>
        _i69.ValidatePassworkUseCase(gh<_i65.UpdatePasswordRepository>()));
    gh.lazySingleton<_i70.ViewApplicantProfileRepository>(
        () => _i71.ViewApplicantProfileRepositoryImpl());
    gh.lazySingleton<_i72.ViewJobRepository>(
        () => _i73.ViewJobRepositoryImpl());
    gh.lazySingleton<_i74.ViewLanguageRepository>(
        () => _i75.ViewLanguageRepositoryImpl());
    gh.lazySingleton<_i76.AddAppreciationUseCase>(
        () => _i76.AddAppreciationUseCase(gh<_i12.AppreciationRepository>()));
    gh.lazySingleton<_i77.AddEducationUseCase>(
        () => _i77.AddEducationUseCase(gh<_i18.EducationRepository>()));
    gh.lazySingleton<_i78.AddExperienceUseCase>(
        () => _i78.AddExperienceUseCase(gh<_i20.ExperienceRepository>()));
    gh.factory<_i79.AddJobCubit>(() => _i79.AddJobCubit(
          gh<_i5.AddJobUseCase>(),
          gh<_i63.UpdateJobUseCase>(),
        ));
    gh.lazySingleton<_i80.AddLanguageUseCase>(
        () => _i80.AddLanguageUseCase(gh<_i28.LanguageRepository>()));
    gh.factory<_i81.AddPostCubit>(() => _i81.AddPostCubit(
          gh<_i8.AddPostUseCase>(),
          gh<_i67.UpdatePostUseCase>(),
        ));
    gh.lazySingleton<_i82.AddResumeUseCase>(
        () => _i82.AddResumeUseCase(gh<_i34.ResumeRepository>()));
    gh.lazySingleton<_i83.ApplyJobRepository>(
        () => _i84.ApplyJobRepositoryImpl(gh<_i42.SendNotificationUseCase>()));
    gh.lazySingleton<_i85.ApplyJobUseCase>(
        () => _i85.ApplyJobUseCase(gh<_i83.ApplyJobRepository>()));
    gh.lazySingleton<_i86.ChangePasswordUseCase>(
        () => _i86.ChangePasswordUseCase(gh<_i65.UpdatePasswordRepository>()));
    gh.lazySingleton<_i87.DeleteAccountUseCase>(
        () => _i87.DeleteAccountUseCase(gh<_i43.SettingRepository>()));
    gh.lazySingleton<_i88.DeleteAllSaveJobUseCase>(
        () => _i88.DeleteAllSaveJobUseCase(gh<_i36.SaveJobRepository>()));
    gh.lazySingleton<_i89.DeleteEducationUseCase>(
        () => _i89.DeleteEducationUseCase(gh<_i18.EducationRepository>()));
    gh.lazySingleton<_i90.DeleteExperienceUseCase>(
        () => _i90.DeleteExperienceUseCase(gh<_i20.ExperienceRepository>()));
    gh.lazySingleton<_i91.DeleteLanguageUseCase>(
        () => _i91.DeleteLanguageUseCase(gh<_i28.LanguageRepository>()));
    gh.lazySingleton<_i92.DeleteNotificationFromIDUseCase>(() =>
        _i92.DeleteNotificationFromIDUseCase(
            gh<_i30.NotificationRepository>()));
    gh.lazySingleton<_i93.DeleteNotificationUseCase>(() =>
        _i93.DeleteNotificationUseCase(gh<_i30.NotificationRepository>()));
    gh.lazySingleton<_i94.DeleteResumeUseCase>(
        () => _i94.DeleteResumeUseCase(gh<_i34.ResumeRepository>()));
    gh.lazySingleton<_i95.FetchJobUseCase>(
        () => _i95.FetchJobUseCase(gh<_i72.ViewJobRepository>()));
    gh.lazySingleton<_i96.FetchJobUseCase>(
        () => _i96.FetchJobUseCase(gh<_i24.HomeRepository>()));
    gh.lazySingleton<_i97.GetAppreciationUseCase>(() =>
        _i97.GetAppreciationUseCase(gh<_i70.ViewApplicantProfileRepository>()));
    gh.lazySingleton<_i98.GetCountriesUseCase>(
        () => _i98.GetCountriesUseCase(gh<_i40.SearchLanguageRepository>()));
    gh.factory<_i99.GetEducationUseCase>(() =>
        _i99.GetEducationUseCase(gh<_i70.ViewApplicantProfileRepository>()));
    gh.lazySingleton<_i100.GetLanguageUseCase>(() =>
        _i100.GetLanguageUseCase(gh<_i70.ViewApplicantProfileRepository>()));
    gh.lazySingleton<_i101.GetListSkillUseCase>(
        () => _i101.GetListSkillUseCase(gh<_i50.SkillRepository>()));
    gh.lazySingleton<_i102.GetResumeUseCase>(() =>
        _i102.GetResumeUseCase(gh<_i70.ViewApplicantProfileRepository>()));
    gh.lazySingleton<_i103.GetUserInfoUseCase>(() =>
        _i103.GetUserInfoUseCase(gh<_i70.ViewApplicantProfileRepository>()));
    gh.lazySingleton<_i104.GetWorkExperienceUseCase>(() =>
        _i104.GetWorkExperienceUseCase(
            gh<_i70.ViewApplicantProfileRepository>()));
    gh.factory<_i105.HomeCubit>(() => _i105.HomeCubit(
          gh<_i96.FetchJobUseCase>(),
          gh<_i38.SaveJobUseCase>(),
        ));
    gh.factory<_i106.JobPositionCubit>(
        () => _i106.JobPositionCubit(gh<_i39.SearchJobPositionUseCase>()));
    gh.lazySingleton<_i107.ListenSaveJobUseCase>(
        () => _i107.ListenSaveJobUseCase(gh<_i36.SaveJobRepository>()));
    gh.factory<_i108.NotificationCubit>(() => _i108.NotificationCubit(
          gh<_i55.StreamNotificationUseCase>(),
          gh<_i33.ReadNotificationUseCase>(),
          gh<_i32.ReadAllNotificationUseCase>(),
          gh<_i92.DeleteNotificationFromIDUseCase>(),
        ));
    gh.lazySingleton<_i109.RegisterApplicantUseCase>(
        () => _i109.RegisterApplicantUseCase(gh<_i48.SignUpRepository>()));
    gh.lazySingleton<_i110.RegisterBusinessUseCase>(
        () => _i110.RegisterBusinessUseCase(gh<_i48.SignUpRepository>()));
    gh.lazySingleton<_i111.RegisterGoogleUseCase>(
        () => _i111.RegisterGoogleUseCase(gh<_i48.SignUpRepository>()));
    gh.factory<_i112.SaveJobCubit>(() => _i112.SaveJobCubit(
          gh<_i107.ListenSaveJobUseCase>(),
          gh<_i88.DeleteAllSaveJobUseCase>(),
          gh<_i38.SaveJobUseCase>(),
        ));
    gh.factory<_i113.SearchLanguageCubit>(
        () => _i113.SearchLanguageCubit(gh<_i98.GetCountriesUseCase>()));
    gh.factory<_i114.SettingCubit>(
        () => _i114.SettingCubit(gh<_i87.DeleteAccountUseCase>()));
    gh.lazySingleton<_i115.SignInEmailPasswordUseCase>(
        () => _i115.SignInEmailPasswordUseCase(gh<_i46.SignInRepository>()));
    gh.lazySingleton<_i116.SignInGoogleUseCase>(
        () => _i116.SignInGoogleUseCase(gh<_i46.SignInRepository>()));
    gh.factory<_i117.SignUpCubit>(() => _i117.SignUpCubit(
          gh<_i109.RegisterApplicantUseCase>(),
          gh<_i110.RegisterBusinessUseCase>(),
          gh<_i111.RegisterGoogleUseCase>(),
        ));
    gh.lazySingleton<_i118.StreamLanguagesUseCase>(
        () => _i118.StreamLanguagesUseCase(gh<_i74.ViewLanguageRepository>()));
    gh.factory<_i119.UpdatePasswordCubit>(() => _i119.UpdatePasswordCubit(
          gh<_i86.ChangePasswordUseCase>(),
          gh<_i69.ValidatePassworkUseCase>(),
        ));
    gh.factory<_i120.ViewJobCubit>(
        () => _i120.ViewJobCubit(gh<_i95.FetchJobUseCase>()));
    gh.factory<_i121.ViewLanguageCubit>(() => _i121.ViewLanguageCubit(
          gh<_i118.StreamLanguagesUseCase>(),
          gh<_i91.DeleteLanguageUseCase>(),
        ));
    gh.lazySingleton<_i122.ViewPostRepository>(
        () => _i123.ViewPostRepositoryImpl(
              gh<_i42.SendNotificationUseCase>(),
              gh<_i93.DeleteNotificationUseCase>(),
            ));
    gh.factory<_i124.AddAppreciationCubit>(() => _i124.AddAppreciationCubit(
          gh<_i76.AddAppreciationUseCase>(),
          gh<_i60.UpdateAppreciationUseCase>(),
          gh<_i16.DeleteAppreciationUseCase>(),
        ));
    gh.factory<_i125.AddEducationCubit>(() => _i125.AddEducationCubit(
          gh<_i77.AddEducationUseCase>(),
          gh<_i89.DeleteEducationUseCase>(),
          gh<_i61.UpdateEducationUseCase>(),
        ));
    gh.factory<_i126.AddLanguageCubit>(() => _i126.AddLanguageCubit(
          gh<_i80.AddLanguageUseCase>(),
          gh<_i64.UpdateLanguageUseCase>(),
        ));
    gh.factory<_i127.AddResumeCubit>(
        () => _i127.AddResumeCubit(gh<_i82.AddResumeUseCase>()));
    gh.factory<_i128.AddSkillCubit>(() => _i128.AddSkillCubit(
          gh<_i101.GetListSkillUseCase>(),
          gh<_i68.UpdateSkillUseCase>(),
        ));
    gh.factory<_i129.AddWorkExperienceCubit>(() => _i129.AddWorkExperienceCubit(
          gh<_i78.AddExperienceUseCase>(),
          gh<_i62.UpdateExperienceUseCase>(),
          gh<_i90.DeleteExperienceUseCase>(),
        ));
    gh.factory<_i130.ApplyJobCubit>(
        () => _i130.ApplyJobCubit(gh<_i85.ApplyJobUseCase>()));
    gh.lazySingleton<_i131.DeleteCommentUseCase>(
        () => _i131.DeleteCommentUseCase(gh<_i122.ViewPostRepository>()));
    gh.lazySingleton<_i132.FavouriteCommentUseCase>(
        () => _i132.FavouriteCommentUseCase(gh<_i122.ViewPostRepository>()));
    gh.lazySingleton<_i133.FavouritePostUseCase>(
        () => _i133.FavouritePostUseCase(gh<_i122.ViewPostRepository>()));
    gh.lazySingleton<_i134.FetchDataCommentFirstLevelUseCase>(() =>
        _i134.FetchDataCommentFirstLevelUseCase(
            gh<_i122.ViewPostRepository>()));
    gh.lazySingleton<_i135.GetReplyCommentUseCase>(
        () => _i135.GetReplyCommentUseCase(gh<_i122.ViewPostRepository>()));
    gh.lazySingleton<_i136.ReplyCommentUseCase>(
        () => _i136.ReplyCommentUseCase(gh<_i122.ViewPostRepository>()));
    gh.lazySingleton<_i137.SendCommentUseCase>(
        () => _i137.SendCommentUseCase(gh<_i122.ViewPostRepository>()));
    gh.factory<_i138.SignInCubit>(() => _i138.SignInCubit(
          gh<_i115.SignInEmailPasswordUseCase>(),
          gh<_i116.SignInGoogleUseCase>(),
        ));
    gh.lazySingleton<_i139.SyncPostDataUseCase>(
        () => _i139.SyncPostDataUseCase(gh<_i122.ViewPostRepository>()));
    gh.factory<_i140.ViewApplicantProfileCubit>(
        () => _i140.ViewApplicantProfileCubit(
              gh<_i97.GetAppreciationUseCase>(),
              gh<_i99.GetEducationUseCase>(),
              gh<_i100.GetLanguageUseCase>(),
              ...
              gh<_i133.FavouritePostUseCase>(),
            ));
    gh.factory<_i141.ViewPostBloc>(() => _i141.ViewPostBloc(
          gh<_i134.FetchDataCommentFirstLevelUseCase>(),
          gh<_i132.FavouriteCommentUseCase>(),
          gh<_i133.FavouritePostUseCase>(),
          gh<_i137.SendCommentUseCase>(),
          gh<_i139.SyncPostDataUseCase>(),
          gh<_i136.ReplyCommentUseCase>(),
          gh<_i135.GetReplyCommentUseCase>(),
          gh<_i131.DeleteCommentUseCase>(),
        ));
    gh.factory<_i142.ApplicantProfileCubit>(() => _i142.ApplicantProfileCubit(
          gh<_i17.DeletePostUseCase>(),
          gh<_i94.DeleteResumeUseCase>(),
          gh<_i54.StreamListPostUseCase>(),
    ...
    gh.factory<_i143.ConnectionCubit>(() => _i143.ConnectionCubit(
...
class _$InjectionModule extends _i144.InjectionModule {}
