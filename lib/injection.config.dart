...
import 'package:jobspot/injection.dart' as _i38;
...
import 'package:jobspot/src/presentations/connection/domain/use_cases/fetch_post_use_case.dart'
    as _i12;
import 'package:jobspot/src/presentations/home/cubit/home_cubit.dart' as _i29;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i25.AddJobCubit>(() => _i25.AddJobCubit(
          gh<_i5.AddJobUseCase>(),
          gh<_i23.UpdateJobUseCase>(),
        ));
    gh.factory<_i26.AddPostCubit>(() => _i26.AddPostCubit(
          gh<_i8.AddPostUseCase>(),
          gh<_i24.UpdatePostUseCase>(),
        ));
    gh.factory<_i27.ConnectionCubit>(
        () => _i27.ConnectionCubit(gh<_i12.FetchPostUseCase>()));
    gh.lazySingleton<_i28.FetchJobUseCase>(
        () => _i28.FetchJobUseCase(gh<_i13.HomeRepository>()));
    gh.factory<_i29.HomeCubit>(
        () => _i29.HomeCubit(gh<_i28.FetchJobUseCase>()));
    gh.factory<_i30.JobPositionCubit>(
        () => _i30.JobPositionCubit(gh<_i17.SearchJobPositionUseCase>()));
    gh.lazySingleton<_i31.RegisterApplicantUseCase>(
        () => _i31.RegisterApplicantUseCase(gh<_i21.SignUpRepository>()));
    gh.lazySingleton<_i32.RegisterBusinessUseCase>(
        () => _i32.RegisterBusinessUseCase(gh<_i21.SignUpRepository>()));
    gh.lazySingleton<_i33.RegisterGoogleUseCase>(
        () => _i33.RegisterGoogleUseCase(gh<_i21.SignUpRepository>()));
    gh.lazySingleton<_i34.SignInEmailPasswordUseCase>(
        () => _i34.SignInEmailPasswordUseCase(gh<_i19.SignInRepository>()));
    gh.lazySingleton<_i35.SignInGoogleUseCase>(
        () => _i35.SignInGoogleUseCase(gh<_i19.SignInRepository>()));
    gh.factory<_i36.SignUpCubit>(() => _i36.SignUpCubit(
          gh<_i31.RegisterApplicantUseCase>(),
          gh<_i32.RegisterBusinessUseCase>(),
          gh<_i33.RegisterGoogleUseCase>(),
        ));
    gh.factory<_i37.SignInCubit>(() => _i37.SignInCubit(
          gh<_i34.SignInEmailPasswordUseCase>(),
          gh<_i35.SignInGoogleUseCase>(),
        ));
    return this;
  }
}
