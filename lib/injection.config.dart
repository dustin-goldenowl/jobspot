...
import 'package:jobspot/injection.dart' as _i166;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i98.DeleteAccountUseCase>(
        () => _i98.DeleteAccountUseCase(gh<_i50.SettingRepository>()));
    gh.lazySingleton<_i99.DeleteAllSaveJobUseCase>(
        () => _i99.DeleteAllSaveJobUseCase(gh<_i40.SaveJobRepository>()));
    gh.lazySingleton<_i100.DeleteEducationUseCase>(
        () => _i100.DeleteEducationUseCase(gh<_i20.EducationRepository>()));
    gh.lazySingleton<_i101.DeleteExperienceUseCase>(
        () => _i101.DeleteExperienceUseCase(gh<_i22.ExperienceRepository>()));
    gh.lazySingleton<_i102.DeleteLanguageUseCase>(
        () => _i102.DeleteLanguageUseCase(gh<_i32.LanguageRepository>()));
    gh.lazySingleton<_i103.DeleteNotificationFromIDUseCase>(() =>
        _i103.DeleteNotificationFromIDUseCase(
            gh<_i34.NotificationRepository>()));
    gh.lazySingleton<_i104.DeleteNotificationUseCase>(() =>
        _i104.DeleteNotificationUseCase(gh<_i34.NotificationRepository>()));
    gh.lazySingleton<_i105.DeleteResumeUseCase>(
        () => _i105.DeleteResumeUseCase(gh<_i38.ResumeRepository>()));
    gh.factory<_i106.EditApplicantProfileCubit>(() =>
        _i106.EditApplicantProfileCubit(gh<_i77.UpdateUserInfoUseCase>()));
    gh.lazySingleton<_i107.FetchJobUseCase>(
        () => _i107.FetchJobUseCase(gh<_i26.HomeApplicantRepository>()));
    gh.lazySingleton<_i108.FetchJobUseCase>(
        () => _i108.FetchJobUseCase(gh<_i83.ViewJobRepository>()));
    gh.lazySingleton<_i109.GetAppreciationUseCase>(() =>
        _i109.GetAppreciationUseCase(
            gh<_i79.ViewApplicantProfileRepository>()));
    gh.lazySingleton<_i110.GetCountriesUseCase>(
        () => _i110.GetCountriesUseCase(gh<_i47.SearchLanguageRepository>()));
    gh.factory<_i111.GetEducationUseCase>(() =>
        _i111.GetEducationUseCase(gh<_i79.ViewApplicantProfileRepository>()));
    gh.lazySingleton<_i112.GetLanguageUseCase>(() =>
        _i112.GetLanguageUseCase(gh<_i79.ViewApplicantProfileRepository>()));
    gh.lazySingleton<_i113.GetListApplicantUseCase>(() =>
        _i113.GetListApplicantUseCase(gh<_i81.ViewJobApplicantRepository>()));
    gh.lazySingleton<_i114.GetListMyJobUseCase>(
        () => _i114.GetListMyJobUseCase(gh<_i28.HomeCompanyRepository>()));
    gh.lazySingleton<_i115.GetListSkillUseCase>(
        () => _i115.GetListSkillUseCase(gh<_i57.SkillRepository>()));
    gh.lazySingleton<_i116.GetResumeUseCase>(() =>
        _i116.GetResumeUseCase(gh<_i79.ViewApplicantProfileRepository>()));
    gh.lazySingleton<_i117.GetUserInfoUseCase>(() =>
        _i117.GetUserInfoUseCase(gh<_i79.ViewApplicantProfileRepository>()));
    gh.lazySingleton<_i118.GetWorkExperienceUseCase>(() =>
        _i118.GetWorkExperienceUseCase(
            gh<_i79.ViewApplicantProfileRepository>()));
    gh.factory<_i119.HomeApplicantCubit>(() => _i119.HomeApplicantCubit(
          gh<_i107.FetchJobUseCase>(),
          gh<_i42.SaveJobUseCase>(),
        ));
    gh.factory<_i120.HomeCompanyCubit>(
        () => _i120.HomeCompanyCubit(gh<_i114.GetListMyJobUseCase>()));
    gh.factory<_i121.JobPositionCubit>(
        () => _i121.JobPositionCubit(gh<_i43.SearchJobPositionUseCase>()));
    gh.lazySingleton<_i122.ListenSaveJobUseCase>(
        () => _i122.ListenSaveJobUseCase(gh<_i40.SaveJobRepository>()));
    gh.factory<_i123.NotificationCubit>(() => _i123.NotificationCubit(
          gh<_i62.StreamNotificationUseCase>(),
          gh<_i37.ReadNotificationUseCase>(),
          gh<_i36.ReadAllNotificationUseCase>(),
          gh<_i103.DeleteNotificationFromIDUseCase>(),
        ));
    gh.lazySingleton<_i124.RegisterApplicantUseCase>(
        () => _i124.RegisterApplicantUseCase(gh<_i55.SignUpRepository>()));
    gh.lazySingleton<_i125.RegisterBusinessUseCase>(
        () => _i125.RegisterBusinessUseCase(gh<_i55.SignUpRepository>()));
    gh.lazySingleton<_i126.RegisterGoogleUseCase>(
        () => _i126.RegisterGoogleUseCase(gh<_i55.SignUpRepository>()));
    gh.factory<_i127.SaveJobCubit>(() => _i127.SaveJobCubit(
          gh<_i122.ListenSaveJobUseCase>(),
          gh<_i99.DeleteAllSaveJobUseCase>(),
          gh<_i42.SaveJobUseCase>(),
        ));
    gh.factory<_i128.SearchJobCubit>(
        () => _i128.SearchJobCubit(gh<_i46.SearchJobUseCase>()));
    gh.factory<_i129.SearchLanguageCubit>(
        () => _i129.SearchLanguageCubit(gh<_i110.GetCountriesUseCase>()));
    gh.factory<_i130.SettingCubit>(() => _i130.SettingCubit(
          gh<_i98.DeleteAccountUseCase>(),
          gh<_i76.UpdateTokenUseCase>(),
        ));
    gh.lazySingleton<_i131.SignInEmailPasswordUseCase>(
        () => _i131.SignInEmailPasswordUseCase(gh<_i53.SignInRepository>()));
    gh.lazySingleton<_i132.SignInGoogleUseCase>(
        () => _i132.SignInGoogleUseCase(gh<_i53.SignInRepository>()));
    gh.factory<_i133.SignUpCubit>(() => _i133.SignUpCubit(
          gh<_i124.RegisterApplicantUseCase>(),
          gh<_i125.RegisterBusinessUseCase>(),
          gh<_i126.RegisterGoogleUseCase>(),
        ));
    gh.lazySingleton<_i134.StreamLanguagesUseCase>(
        () => _i134.StreamLanguagesUseCase(gh<_i85.ViewLanguageRepository>()));
    gh.factory<_i135.UpdatePasswordCubit>(() => _i135.UpdatePasswordCubit(
          gh<_i97.ChangePasswordUseCase>(),
          gh<_i78.ValidatePassworkUseCase>(),
        ));
    gh.lazySingleton<_i136.ViewCompanyProfileRepository>(
        () => _i137.ViewCompanyProfileRepositoryImpl(
              gh<_i104.DeleteNotificationUseCase>(),
              gh<_i49.SendNotificationUseCase>(),
            ));
    gh.factory<_i138.ViewJobApplicantCubit>(
        () => _i138.ViewJobApplicantCubit(gh<_i113.GetListApplicantUseCase>()));
    gh.factory<_i139.ViewJobCubit>(
        () => _i139.ViewJobCubit(gh<_i108.FetchJobUseCase>()));
    gh.factory<_i140.ViewLanguageCubit>(() => _i140.ViewLanguageCubit(
          gh<_i134.StreamLanguagesUseCase>(),
          gh<_i102.DeleteLanguageUseCase>(),
        ));
    gh.lazySingleton<_i141.ViewPostRepository>(
        () => _i142.ViewPostRepositoryImpl(
              gh<_i49.SendNotificationUseCase>(),
              gh<_i104.DeleteNotificationUseCase>(),
            ));
    gh.factory<_i143.AddAppreciationCubit>(() => _i143.AddAppreciationCubit(
          gh<_i87.AddAppreciationUseCase>(),
          gh<_i67.UpdateAppreciationUseCase>(),
          gh<_i16.DeleteAppreciationUseCase>(),
        ));
    gh.factory<_i144.AddEducationCubit>(() => _i144.AddEducationCubit(
          gh<_i88.AddEducationUseCase>(),
          gh<_i100.DeleteEducationUseCase>(),
          gh<_i68.UpdateEducationUseCase>(),
        ));
    gh.factory<_i145.AddLanguageCubit>(() => _i145.AddLanguageCubit(
          gh<_i91.AddLanguageUseCase>(),
          gh<_i71.UpdateLanguageUseCase>(),
        ));
    gh.factory<_i146.AddResumeCubit>(
        () => _i146.AddResumeCubit(gh<_i93.AddResumeUseCase>()));
    gh.factory<_i147.AddSkillCubit>(() => _i147.AddSkillCubit(
          gh<_i115.GetListSkillUseCase>(),
          gh<_i75.UpdateSkillUseCase>(),
        ));
    gh.factory<_i148.AddWorkExperienceCubit>(() => _i148.AddWorkExperienceCubit(
          gh<_i89.AddExperienceUseCase>(),
          gh<_i69.UpdateExperienceUseCase>(),
          gh<_i101.DeleteExperienceUseCase>(),
        ));
    gh.factory<_i149.ApplyJobCubit>(
        () => _i149.ApplyJobCubit(gh<_i96.ApplyJobUseCase>()));
    gh.lazySingleton<_i150.DeleteCommentUseCase>(
        () => _i150.DeleteCommentUseCase(gh<_i141.ViewPostRepository>()));
    gh.lazySingleton<_i151.FavouriteCommentUseCase>(
        () => _i151.FavouriteCommentUseCase(gh<_i141.ViewPostRepository>()));
    gh.lazySingleton<_i152.FavouritePostUseCase>(
        () => _i152.FavouritePostUseCase(gh<_i141.ViewPostRepository>()));
    gh.lazySingleton<_i153.FetchDataCommentFirstLevelUseCase>(() =>
        _i153.FetchDataCommentFirstLevelUseCase(
            gh<_i141.ViewPostRepository>()));
    gh.lazySingleton<_i154.FollowUserUseCase>(() =>
        _i154.FollowUserUseCase(gh<_i136.ViewCompanyProfileRepository>()));
    gh.lazySingleton<_i155.GetListJobUseCase>(() =>
        _i155.GetListJobUseCase(gh<_i136.ViewCompanyProfileRepository>()));
    gh.lazySingleton<_i156.GetReplyCommentUseCase>(
        () => _i156.GetReplyCommentUseCase(gh<_i141.ViewPostRepository>()));
    gh.lazySingleton<_i157.ReplyCommentUseCase>(
        () => _i157.ReplyCommentUseCase(gh<_i141.ViewPostRepository>()));
    gh.lazySingleton<_i158.SendCommentUseCase>(
        () => _i158.SendCommentUseCase(gh<_i141.ViewPostRepository>()));
    gh.factory<_i159.SignInCubit>(() => _i159.SignInCubit(
          gh<_i131.SignInEmailPasswordUseCase>(),
          gh<_i132.SignInGoogleUseCase>(),
          gh<_i76.UpdateTokenUseCase>(),
        ));
    gh.lazySingleton<_i160.SyncPostDataUseCase>(
        () => _i160.SyncPostDataUseCase(gh<_i141.ViewPostRepository>()));
    gh.factory<_i161.ViewApplicantProfileCubit>(
        () => _i161.ViewApplicantProfileCubit(
              gh<_i109.GetAppreciationUseCase>(),
              gh<_i111.GetEducationUseCase>(),
              gh<_i112.GetLanguageUseCase>(),
              gh<_i116.GetResumeUseCase>(),
              gh<_i25.GetSkillUseCase>(),
              gh<_i117.GetUserInfoUseCase>(),
              gh<_i118.GetWorkExperienceUseCase>(),
              gh<_i61.StreamListPostUseCase>(),
              gh<_i152.FavouritePostUseCase>(),
            ));
    gh.factory<_i162.ViewCompanyProfileCubit>(
        () => _i162.ViewCompanyProfileCubit(
              gh<_i155.GetListJobUseCase>(),
              gh<_i61.StreamListPostUseCase>(),
              gh<_i117.GetUserInfoUseCase>(),
              gh<_i152.FavouritePostUseCase>(),
              gh<_i154.FollowUserUseCase>(),
            ));
    gh.factory<_i163.ViewPostBloc>(() => _i163.ViewPostBloc(
          gh<_i153.FetchDataCommentFirstLevelUseCase>(),
          gh<_i151.FavouriteCommentUseCase>(),
          gh<_i152.FavouritePostUseCase>(),
          gh<_i158.SendCommentUseCase>(),
          gh<_i160.SyncPostDataUseCase>(),
          gh<_i157.ReplyCommentUseCase>(),
          gh<_i156.GetReplyCommentUseCase>(),
          gh<_i150.DeleteCommentUseCase>(),
        ));
    gh.factory<_i164.ApplicantProfileCubit>(() => _i164.ApplicantProfileCubit(
          gh<_i17.DeletePostUseCase>(),
          gh<_i105.DeleteResumeUseCase>(),
          gh<_i61.StreamListPostUseCase>(),
    ...
    gh.factory<_i165.ConnectionCubit>(() => _i165.ConnectionCubit(
...
class _$InjectionModule extends _i166.InjectionModule {}
