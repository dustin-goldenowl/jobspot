...
import 'package:jobspot/src/presentations/connection/domain/use_cases/fetch_post_use_case.dart'
    as _i25;
import 'package:jobspot/src/presentations/home/cubit/home_cubit.dart' as _i74;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i61.ApplicantProfileCubit>(() => _i61.ApplicantProfileCubit(
    ...
    gh.factory<_i62.ApplyJobCubit>(
        () => _i62.ApplyJobCubit(gh<_i14.ApplyJobUseCase>()));
    gh.lazySingleton<_i63.DeleteAllSaveJobUseCase>(
        () => _i63.DeleteAllSaveJobUseCase(gh<_i37.SaveJobRepository>()));
    gh.lazySingleton<_i64.DeleteCommentUseCase>(
        () => _i64.DeleteCommentUseCase(gh<_i53.ViewPostRepository>()));
    gh.lazySingleton<_i65.DeleteEducationUseCase>(
        () => _i65.DeleteEducationUseCase(gh<_i21.EducationRepository>()));
    gh.lazySingleton<_i66.DeleteExperienceUseCase>(
        () => _i66.DeleteExperienceUseCase(gh<_i23.ExperienceRepository>()));
    gh.lazySingleton<_i67.DeleteResumeUseCase>(
        () => _i67.DeleteResumeUseCase(gh<_i35.ResumeRepository>()));
    gh.lazySingleton<_i68.FavouriteCommentUseCase>(
        () => _i68.FavouriteCommentUseCase(gh<_i53.ViewPostRepository>()));
    gh.lazySingleton<_i69.FavouritePostUseCase>(
        () => _i69.FavouritePostUseCase(gh<_i53.ViewPostRepository>()));
    gh.lazySingleton<_i70.FetchDataCommentFirstLevelUseCase>(() =>
        _i70.FetchDataCommentFirstLevelUseCase(gh<_i53.ViewPostRepository>()));
    gh.lazySingleton<_i71.FetchJobUseCase>(
        () => _i71.FetchJobUseCase(gh<_i31.HomeRepository>()));
    gh.lazySingleton<_i72.FetchJobUseCase>(
        () => _i72.FetchJobUseCase(gh<_i51.ViewJobRepository>()));
    gh.lazySingleton<_i73.GetReplyCommentUseCase>(
        () => _i73.GetReplyCommentUseCase(gh<_i53.ViewPostRepository>()));
    gh.factory<_i74.HomeCubit>(() => _i74.HomeCubit(
          gh<_i71.FetchJobUseCase>(),
          gh<_i39.SaveJobUseCase>(),
        ));
    gh.factory<_i75.JobPositionCubit>(
        () => _i75.JobPositionCubit(gh<_i40.SearchJobPositionUseCase>()));
    gh.lazySingleton<_i76.ListenSaveJobUseCase>(
        () => _i76.ListenSaveJobUseCase(gh<_i37.SaveJobRepository>()));
    gh.lazySingleton<_i77.RegisterApplicantUseCase>(
        () => _i77.RegisterApplicantUseCase(gh<_i44.SignUpRepository>()));
    gh.lazySingleton<_i78.RegisterBusinessUseCase>(
        () => _i78.RegisterBusinessUseCase(gh<_i44.SignUpRepository>()));
    gh.lazySingleton<_i79.RegisterGoogleUseCase>(
        () => _i79.RegisterGoogleUseCase(gh<_i44.SignUpRepository>()));
    gh.lazySingleton<_i80.ReplyCommentUseCase>(
        () => _i80.ReplyCommentUseCase(gh<_i53.ViewPostRepository>()));
    gh.factory<_i81.SaveJobCubit>(() => _i81.SaveJobCubit(
          gh<_i76.ListenSaveJobUseCase>(),
          gh<_i63.DeleteAllSaveJobUseCase>(),
          gh<_i39.SaveJobUseCase>(),
        ));
    gh.lazySingleton<_i82.SendCommentUseCase>(
        () => _i82.SendCommentUseCase(gh<_i53.ViewPostRepository>()));
    gh.lazySingleton<_i83.SignInEmailPasswordUseCase>(
        () => _i83.SignInEmailPasswordUseCase(gh<_i42.SignInRepository>()));
    gh.lazySingleton<_i84.SignInGoogleUseCase>(
        () => _i84.SignInGoogleUseCase(gh<_i42.SignInRepository>()));
    gh.factory<_i85.SignUpCubit>(() => _i85.SignUpCubit(
          gh<_i77.RegisterApplicantUseCase>(),
          gh<_i78.RegisterBusinessUseCase>(),
          gh<_i79.RegisterGoogleUseCase>(),
        ));
    gh.lazySingleton<_i86.SyncPostDataUseCase>(
        () => _i86.SyncPostDataUseCase(gh<_i53.ViewPostRepository>()));
    gh.factory<_i87.ViewJobCubit>(
        () => _i87.ViewJobCubit(gh<_i72.FetchJobUseCase>()));
    gh.factory<_i88.ViewPostBloc>(() => _i88.ViewPostBloc(
          gh<_i70.FetchDataCommentFirstLevelUseCase>(),
          gh<_i68.FavouriteCommentUseCase>(),
          gh<_i69.FavouritePostUseCase>(),
          gh<_i82.SendCommentUseCase>(),
          gh<_i86.SyncPostDataUseCase>(),
          gh<_i80.ReplyCommentUseCase>(),
          gh<_i73.GetReplyCommentUseCase>(),
          gh<_i64.DeleteCommentUseCase>(),
        ));
    gh.factory<_i89.AddAppreciationCubit>(() => _i89.AddAppreciationCubit(
          gh<_i55.AddAppreciationUseCase>(),
          gh<_i46.UpdateAppreciationUseCase>(),
          gh<_i19.DeleteAppreciationUseCase>(),
        ));
    gh.factory<_i90.AddEducationCubit>(() => _i90.AddEducationCubit(
          gh<_i56.AddEducationUseCase>(),
          gh<_i65.DeleteEducationUseCase>(),
          gh<_i47.UpdateEducationUseCase>(),
        ));
    gh.factory<_i91.AddResumeCubit>(
        () => _i91.AddResumeCubit(gh<_i60.AddResumeUseCase>()));
    gh.factory<_i92.AddWorkExperienceCubit>(() => _i92.AddWorkExperienceCubit(
          gh<_i57.AddExperienceUseCase>(),
          gh<_i48.UpdateExperienceUseCase>(),
          gh<_i66.DeleteExperienceUseCase>(),
        ));
    ...
    gh.factory<_i94.SignInCubit>(() => _i94.SignInCubit(
          gh<_i83.SignInEmailPasswordUseCase>(),
          gh<_i84.SignInGoogleUseCase>(),
        ));
    return this;
  }
}
