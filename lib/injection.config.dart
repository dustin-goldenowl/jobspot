...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i125.ViewCompanyProfileRepository>(
        () => _i126.ViewCompanyProfileRepositoryImpl(
              gh<_i97.DeleteNotificationUseCase>(),
              gh<_i44.SendNotificationUseCase>(),
            ));
    gh.factory<_i127.ViewJobCubit>(
        () => _i127.ViewJobCubit(gh<_i100.FetchJobUseCase>()));
    gh.factory<_i128.ViewLanguageCubit>(() => _i128.ViewLanguageCubit(
          gh<_i123.StreamLanguagesUseCase>(),
          gh<_i95.DeleteLanguageUseCase>(),
        ));
    gh.lazySingleton<_i129.ViewPostRepository>(
        () => _i130.ViewPostRepositoryImpl(
              gh<_i44.SendNotificationUseCase>(),
              gh<_i97.DeleteNotificationUseCase>(),
            ));
    gh.factory<_i131.AddAppreciationCubit>(() => _i131.AddAppreciationCubit(
          gh<_i80.AddAppreciationUseCase>(),
          gh<_i62.UpdateAppreciationUseCase>(),
          gh<_i16.DeleteAppreciationUseCase>(),
        ));
    gh.factory<_i132.AddEducationCubit>(() => _i132.AddEducationCubit(
          gh<_i81.AddEducationUseCase>(),
          gh<_i93.DeleteEducationUseCase>(),
          gh<_i63.UpdateEducationUseCase>(),
        ));
    gh.factory<_i133.AddLanguageCubit>(() => _i133.AddLanguageCubit(
          gh<_i84.AddLanguageUseCase>(),
          gh<_i66.UpdateLanguageUseCase>(),
        ));
    gh.factory<_i134.AddResumeCubit>(
        () => _i134.AddResumeCubit(gh<_i86.AddResumeUseCase>()));
    gh.factory<_i135.AddSkillCubit>(() => _i135.AddSkillCubit(
          gh<_i106.GetListSkillUseCase>(),
          gh<_i70.UpdateSkillUseCase>(),
        ));
    gh.factory<_i136.AddWorkExperienceCubit>(() => _i136.AddWorkExperienceCubit(
          gh<_i82.AddExperienceUseCase>(),
          gh<_i64.UpdateExperienceUseCase>(),
          gh<_i94.DeleteExperienceUseCase>(),
        ));
    gh.factory<_i137.ApplyJobCubit>(
        () => _i137.ApplyJobCubit(gh<_i89.ApplyJobUseCase>()));
    gh.lazySingleton<_i138.DeleteCommentUseCase>(
        () => _i138.DeleteCommentUseCase(gh<_i129.ViewPostRepository>()));
    gh.lazySingleton<_i139.FavouriteCommentUseCase>(
        () => _i139.FavouriteCommentUseCase(gh<_i129.ViewPostRepository>()));
    gh.lazySingleton<_i140.FavouritePostUseCase>(
        () => _i140.FavouritePostUseCase(gh<_i129.ViewPostRepository>()));
    gh.lazySingleton<_i141.FetchDataCommentFirstLevelUseCase>(() =>
        _i141.FetchDataCommentFirstLevelUseCase(
            gh<_i129.ViewPostRepository>()));
    gh.lazySingleton<_i142.FollowUserUseCase>(() =>
        _i142.FollowUserUseCase(gh<_i125.ViewCompanyProfileRepository>()));
    gh.lazySingleton<_i143.GetListJobUseCase>(() =>
        _i143.GetListJobUseCase(gh<_i125.ViewCompanyProfileRepository>()));
    gh.lazySingleton<_i144.GetReplyCommentUseCase>(
        () => _i144.GetReplyCommentUseCase(gh<_i129.ViewPostRepository>()));
    gh.lazySingleton<_i145.ReplyCommentUseCase>(
        () => _i145.ReplyCommentUseCase(gh<_i129.ViewPostRepository>()));
    gh.lazySingleton<_i146.SendCommentUseCase>(
        () => _i146.SendCommentUseCase(gh<_i129.ViewPostRepository>()));
    ...
    gh.lazySingleton<_i148.SyncPostDataUseCase>(
        () => _i148.SyncPostDataUseCase(gh<_i129.ViewPostRepository>()));
